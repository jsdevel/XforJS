 ...
 */
test("ProductionContext", function(){
   ...
   test("call management",function(){
      var output = new Output();
      var context = new ProductionContext(output, new Compiler()).addProduction({
         close:function(){}
      });
