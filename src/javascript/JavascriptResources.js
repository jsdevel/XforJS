...
var JavascriptResources={
   ...
   getGetSortArray:function(){
      return "(function(l,s,i){var r=[],a,v,o;try{o=l()}catch(e){o=l}if(!!o&&typeof(o)==='object'){for(a in o){try{v=s(o[a]);r.push({n:a,c:o[a],v:v,k:typeof(v)==='string'&&i?v.toLowerCase():v});}catch(e){r.push({n:a,c:o[a],k:''});}}}return r})";
   },
   getForeach:function(){
      return "(function(o,c,so,n,p){var i=0,l,m;if(!!o&&typeof(o)==='object'&&typeof(c)==='function'){l=o.length;if(so!==void(0))o.sort(function(c,d){var a=c.k,b=d.k,at=typeof(a),bt=typeof(b);if(a===b){switch(p){case(2):return c.v>d.v?1:-1;case(1):return c.v<d.v?1:-1;default:return 0;}}if(at===bt)return (!!so?a<b:a>b)?-1:1;return (!!n?at<bt:at>bt)?-1:1});for(;i<l;i++){m=o[i];c(m.c,i+1,o.length,m.n)}}})";
   },
